...
def baked_goods_by_price():
    ...
    for good in BakedGood.query.order_by(db.desc(BakedGood.price)):
        baked_good_dict = good.to_dict()
...
def most_expensive_baked_good():
    most_expensive_good = BakedGood.query.order_by(db.desc(BakedGood.price)).first()
